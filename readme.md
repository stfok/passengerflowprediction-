...
Model Input/Output
Input: Sequence of station entry flows (4 ¡Á 15-min intervals)
...
©À©¤©¤ data/                   # Data files
©¦   ©À©¤©¤ metro_network.json  # Metro topology
©¦   ©À©¤©¤ afc_data.csv        # AFC data
©¦   ©¸©¤©¤ processed/          # Preprocessed data
©À©¤©¤ model/                  # Model implementations
©¦   ©À©¤©¤ dgnn.py             # Directed Graph Neural Network
©¦   ©À©¤©¤ s_dgnn.py           # S-DGNN main model
©¦   ©¸©¤©¤ prophet_wrapper.py  # Prophet correlation prediction
©À©¤©¤ utils/                  # Utility modules
©¦   ©À©¤©¤ graph_builder.py    # Graph construction
©¦   ©À©¤©¤ data_loader.py      # Data loading
©¦   ©¸©¤©¤ metrics.py          # Evaluation metrics
©À©¤©¤ config.py               # Configuration
©À©¤©¤ train.py                # Model training
©À©¤©¤ test.py                 # Model testing
